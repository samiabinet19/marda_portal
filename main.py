...
# 🟢 MongoDB Connection Setup (Cloud Persistent Storage)
...
# ------------------ 4. MongoDB Helper Functions (ዳታ እንዳይጠፋ በupsert የተጠናከረ) ------------------
...
def add_user_if_not_exists(user_id: int):
  """ተጠቃሚው ከሌለ በአዲስ መልክ ይመዝግባል፣ ካለ ግን ያለውን ዳታ አይነካም (ዳታ እንዳይጠፋ)"""
...
def update_user(user_id: int, **kwargs):
  """የተጠቃሚውን መረጃ ሲያዘምን የነበረውን ዳታ ሳይሰርዝ እንዲስተካከል ያደርጋል"""
...
# ------------------ 9. General Broadcast & Revoke Handlers ------------------
...
if __name__ == '__main__':
  ...
  broadcast_handler = ConversationHandler(
      ...
      fallbacks=[
          CommandHandler('cancel', cancel if 'cancel' in globals() else None),
      ],
      allow_reentry=True,
  )
